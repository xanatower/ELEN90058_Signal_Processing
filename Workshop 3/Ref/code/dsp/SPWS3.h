...
#define DOWNSAMPLE 2
#define Fs (int)(48000/DOWNSAMPLE)
...
void transfer_data_in(void);
void transfer_data_out(void);

// Process_data.c
void process_data(void);

extern fract32 input_data[];
extern fract32* output_current;

// LabTasks.c
float process_time(float);
void init_process(void);
void process_block(fract32[]);
